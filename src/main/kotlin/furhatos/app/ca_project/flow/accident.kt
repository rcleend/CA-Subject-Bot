...
import furhatos.app.ca_project.nlu.intents.ExplainAccident
...
val Accident = partialState {
    ...
    onResponse<RequestAboutNoise>{
        ...
        val rf = ResponseFrame(arrayOf(
            ...
            ResponseValues(RuleDimensions.X2Y1.get(), X2Y1, "I'm sorry but I heard nothing."),
            ...
            ResponseValues(RuleDimensions.X0Y1.get(), X0Y1, "I just got out; I heard nothing."),
