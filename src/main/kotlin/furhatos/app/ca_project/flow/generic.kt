...
val Generic = partialState {
    onResponseFailed {
        val rf = ResponseFrame(arrayOf(
            ResponseValues(RuleDimensions.X2Y2.get(), X2Y2, "I'm sorry but I don't know how to answer that."),
            ResponseValues(RuleDimensions.X2Y1.get(), X2Y1, "Sorry, I don't know how to answer that."),
            ResponseValues(RuleDimensions.X2Y0.get(), X2Y0, "I don't know how to answer that."),
            ResponseValues(RuleDimensions.X1Y2.get(), X1Y2, "Sorry, I don't know how to answer that."),
            ResponseValues(RuleDimensions.X1Y1.get(), X1Y1, "I don't know how to answer that."),
            ResponseValues(RuleDimensions.X1Y0.get(), X1Y0, "Uhm? I don't know."),
            ResponseValues(RuleDimensions.X0Y2.get(), X0Y2, "I don't know how to answer that."),
